class DailySiteReportMeta {
  ...
  factory DailySiteReportMeta.fromMap(Map<String, dynamic> map) => DailySiteReportMeta(
    ...
    progressQuantity: map['progress_quantity'] == null ? null : (map['progress_quantity'] as num).toDouble(),
    progressUnit: map['progress_unit'] as String?,
    percentComplete: map['percent_complete'] == null ? null : (map['percent_complete'] as num).toDouble(),
